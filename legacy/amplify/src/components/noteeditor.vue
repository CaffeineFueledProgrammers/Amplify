<template>
    <div class="note-editor">
        <slot v-bind="{ editor }" />
        <editor-content :editor="editor" class="prose dark:text-gray-100 max-w-none prose-indigo" />
...
export default {
    ...
    setup(props, { emit }) {
        ...
        onMounted(() => {
            ...
            editor.value.options.element.style.fontSize = (localStorage.getItem("font-size") || "16") + "px";
